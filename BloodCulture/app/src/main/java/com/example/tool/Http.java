...
public final class Http {
     ...
     * @return
     */
    public static JsonObject getDevicesByType(String type){
        try {
            JsonObject json = new JsonObject();
     ...
     * 获取瓶孔预览
     * @param machineID 设备号
     * @param extensionNum 分机号
     * @return
     */
    public static JsonObject getHoleSummary(String machineID,String extensionNum){
        try {
            JsonObject json = new JsonObject();
